...
using Test.Databases.App.Tables.Competition;
using Test.Databases.App.Tables.SoloPool;

namespace Test.Databases.App
{
    public class JournalDbContext : DbContext // database
    {
        ...
        public DbSet<App.Tables.SoloPool.Table> SoloPools { get; set; }
